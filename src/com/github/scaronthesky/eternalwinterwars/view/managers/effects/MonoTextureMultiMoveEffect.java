 ...
 * 
 */
public class MonoTextureMultiMoveEffect extends AEffect {

	public MonoTextureMultiMoveEffect(final IController pController,
			final float pX, final float pY, final Scene pParentScene,
			final float pDuration, final ITextureRegion pTextureRegion,
